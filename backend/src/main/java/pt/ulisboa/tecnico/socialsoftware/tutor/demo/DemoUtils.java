...
public class DemoUtils {
    ...
    public void resetDemoInfo() {
        ...
        demoService.resetDemoQuestionAnswers();
        demoService.resetDemoDetails();
        demoService.resetDemoQuizQuestions();
        demoService.resetDemoAnswers();
        demoService.resetDemoTournaments();
        demoService.resetDemoQuizzes();
        demoService.resetDemoQuizAnswers();
        demoService.resetDemoCourseQuizzes();
        demoService.resetDemoQuestionSubmissions();
        demoService.resetDemoStudents();
        demoService.resetDemoExecutions();
